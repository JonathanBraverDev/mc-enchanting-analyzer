...
- Opt-in Flex/factorized-tree experiments behind `searchBackend: 'flex'`. Concrete `SearchRun` remains the correctness reference while this path is evaluated.
