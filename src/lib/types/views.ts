...
import type { ClueSignalAdvisorView, TargetClueAdvisorView, TargetDiagnosticsView } from '#lib/types/target.js';
...
export interface TopRunView {
  ...
  clueSignalAdvisor?: ClueSignalAdvisorView | undefined;
}
