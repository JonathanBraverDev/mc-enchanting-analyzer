...
Start here when you need the maintained project documentation:
...
- [`rank-pool-merge-design.md`](rank-pool-merge-design.md) - experimental design note for rank-only pool sharing.
