...
import type { NameResolver, CompactStats, EnchantInsights, ResultSortMode } from './types.js';
...
export class ResultProcessor {
     ...
     */
    static summarize(combos: Map<bigint, bigint>, uncertainty: bigint, anyMass?: Map<number, bigint>, rankMass?: Map<number, bigint>, countMass?: Map<number, bigint>, comboLimit: number = ENGINE_DEFAULTS.MAX_RESULTS_SUMMARY): any {
        const stats: any = {
            ranks: {},
            any: {},
            count: {},
        ...
        // Serialize limited combinations for the UI/Worker transfer
    ...
    /**
     * Converts raw statistics into a human-readable format with optional sorting.
     */
    static humanize(stats: any, resolver: NameResolver, sortMode: ResultSortMode = 'prob', romanMap?: Record<string, number>): EnchantInsights {
