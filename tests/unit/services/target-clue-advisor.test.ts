...
describe('TargetClueAdvisorService', () => {
    ...
    it('ranks clues by target chance conditioned on the shown clue', () => {
        ...
        assert.strictEqual(ProbUtils.toNumber(result!.recommendations[0]!.anyBaselineChanceMass), 0.25);
        assert.strictEqual(result!.recommendations[0]!.liftOverAnyBaseline, 2);
    ...
    it('includes pending frontier mass in clue recommendations', () => {
        ...
        const result = TargetClueAdvisorService.recommend({
            ...
            targets,
            registry,
            pendingEntries: [makePendingEntry(matching, 2, PRECISION / 2n)],
            limit: 2
        });
        ...
        const sweep = [
            {
                ...
                clueAdvisor: {
                    recommendations: [{
                        ...
                        anyBaselineChance: 0.08,
                        liftOverAnyBaseline: 2.5,
            ...
            },
            {
                ...
                clueAdvisor: {
                    recommendations: [{
                        ...
                        anyBaselineChance: 0.125,
                        liftOverAnyBaseline: 4,
