...
describe('Enchantment Engine Regression Snapshots', () => {
    it('Snapshot: 1.8 Diamond Sword @ Level 30', async () => {
        ...
        const stats = await engine.calculate(TEST_DATA.ITEMS.SWORD, 30, TEST_DATA.MATERIALS.DIAMOND, { threshold: TEST_DEFAULTS.SNAPSHOT_THRESHOLD, maxIterations: TEST_DEFAULTS.SNAPSHOT_ITERATIONS, summaryLimit: TEST_DEFAULTS.SNAPSHOT_RESULTS_LIMIT, resultsLimit: TEST_DEFAULTS.SNAPSHOT_RESULTS_LIMIT, useCache: false });
    ...
    it('Snapshot: 1.21 Mace @ Level 30', async () => {
        ...
        const stats = await engine.calculate(TEST_DATA.ITEMS.MACE, 30, TEST_DATA.MATERIALS.MACE, { threshold: TEST_DEFAULTS.SNAPSHOT_THRESHOLD, maxIterations: TEST_DEFAULTS.SNAPSHOT_ITERATIONS, summaryLimit: TEST_DEFAULTS.SNAPSHOT_RESULTS_LIMIT, resultsLimit: TEST_DEFAULTS.SNAPSHOT_RESULTS_LIMIT, useCache: false });
    ...
    it('Snapshot: 1.21.11 Spear @ Level 30', async () => {
        ...
        const stats = await engine.calculate(TEST_DATA.ITEMS.SPEAR, 30, TEST_DATA.MATERIALS.DIAMOND, { threshold: TEST_DEFAULTS.SNAPSHOT_THRESHOLD, maxIterations: TEST_DEFAULTS.SNAPSHOT_ITERATIONS, summaryLimit: TEST_DEFAULTS.SNAPSHOT_RESULTS_LIMIT, resultsLimit: TEST_DEFAULTS.SNAPSHOT_RESULTS_LIMIT, useCache: false });
    ...
    it('Snapshot: 1.7.2 Multi-Enchant Book @ Level 30', async () => {
        ...
        const stats = await engine.calculate(TEST_DATA.ITEMS.BOOK, 30, TEST_DATA.MATERIALS.BOOK, { threshold: TEST_DEFAULTS.SNAPSHOT_THRESHOLD, maxIterations: TEST_DEFAULTS.SNAPSHOT_ITERATIONS, summaryLimit: TEST_DEFAULTS.SNAPSHOT_RESULTS_LIMIT, resultsLimit: TEST_DEFAULTS.SNAPSHOT_RESULTS_LIMIT, useCache: false });
